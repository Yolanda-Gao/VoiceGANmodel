...
class Discriminator(nn.Module):
    def __init__(
        ...
        self.conv7 = nn.Conv2d(64 * 8, 64 * 8, 4, 2, 1, bias=False)
        self.bn7 = nn.BatchNorm2d(64 * 8)
        self.relu7 = nn.LeakyReLU(0.2, inplace=True)

        self.conv8 = nn.Conv2d(64 * 8, 1, 4, 1, 0, bias=False)
    ...
    def forward(self, input):
        ...
        return torch.sigmoid( conv8 ), [relu2, relu3, relu4, relu5, relu6, relu7]
